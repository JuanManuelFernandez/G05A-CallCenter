    ...
    <div class="container mt-4">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-3">
                ...
                <asp:TextBox ID="txtMail" runat="server" CssClass="form-control w-100" Enabled="false" required="required" OnTextChanged="txtMail_TextChanged" AutoPostBack="true" TextMode="Email"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-3">
                ...
                <asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control w-100" Enabled="false" required="required" OnTextChanged="txtTelefono_TextChanged" AutoPostBack="true" TextMode="Number" min=1></asp:TextBox>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-3">
